...
const Projects = () => {
  return (
    <section id='projects' className='pt-10 mt-4'>
      <h2 className='section-heading text-center'>Projects</h2>
        <div className=' mt-10'>
            {projects.map(project => {
                return (
                    <div className='lg:grid lg:grid-cols-3 gap-20 place-items-center mb-20' key={project.id}>
                        ...
                        <div className=''>
                            ...
                            <p className='text-center text-gray-700 px-5 sm:p-0 my-4'>{project.descrition}</p>
