  ...
  return (
    <div id='home' className='flex justify-around items-center py-10'>
        <div className='text-center md:text-start'>
            ...
            <p className='italic w-80 text-gray-500 mt-4'>I am the next <span className='text-cyan-500'>Developer</span> you have been looking for.</p>
            ...
            <button className='text-white border-2 bg-cyan-400 border-cyan-400 rounded font-bold hover:text-cyan-400 hover:bg-white px-3 py-1 mt-9 mr-5 transition ease-out hover:scale-110'><a href='https://drive.google.com/file/d/1ARNVusPFuzgqgQHK_amiOmMb4qKGspOV/view?usp=drivesdk' target='_blank'>Resume</a></button>
